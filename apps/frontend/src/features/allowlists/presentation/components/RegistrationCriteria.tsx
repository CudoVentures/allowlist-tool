                ...
                <Fragment>
                    <Box width='100%' id='allowlistTwitterAccountToFollowInput'>
                        <Box sx={registrationCriteriaStyles.titleSwitchHolder}>
                            ...
                            <Switch checked={allowlistState.checkedFields['twitter_account_to_follow']} value={'twitter_account_to_follow'} onChange={((e) => handleSwitch(e))} />
                        </Box>
                    ...
                    <Box width='100%' id='allowlistDiscordGroupToJoinInput'>
                        <Box sx={registrationCriteriaStyles.titleSwitchHolder}>
                            ...
                            <Switch checked={allowlistState.checkedFields['discord_server']} value={'discord_server'} onChange={((e) => handleSwitch(e))} />
                        </Box>
                    ...
                    <Box width='100%' id='allowlistDiscordGroupRoleInput'>
                        <Box sx={registrationCriteriaStyles.titleSwitchHolder}>
                            ...
                            <Switch checked={allowlistState.checkedFields['server_role']} disabled={!allowlistState.checkedFields['discord_server'] || !allowlistState.discord_server} value={'server_role'} onChange={((e) => handleSwitch(e))} />
                        </Box>
